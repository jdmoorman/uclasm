...
def elimination_filter(exact_smp, *,
                       changed_cands=None,
                       verbose=False,
                       **kwargs):
    """
    ...
    for node_idx in centrality_ordered_node_idxs(tmplt, world, candidates):
        ...
        for i, cand_idx in enumerate(cand_idxs):
            ...
            candidates_copy = smp_copy.candidates
            ...
            run_filters(smp_copy, filters=cheap_filters,
