...
def recursive_alldiff_counter(tnode_to_eqids, eq_classes, eq_class_sizes, curr_solution=None, solutions=None):
    ...
    for eqid in eqids:
        ...
        curr_solution.append((tnode, eq_classes[eqid]))
        # Count the number of ways to assign the rest of candidates
        n_ways_to_assign_rest = recursive_alldiff_counter(tnode_to_eqids, eq_classes, eq_class_sizes, curr_solution, solutions)
        curr_solution.pop()
...
def count_alldiffs(tnode_to_cands, solutions=None):
    """
    ...
    count = recursive_alldiff_counter(tnode_to_eqids, eq_classes, eq_class_sizes, solutions=solutions)
